...
[vignettes](https://rformassspectrometry.r-universe.dev/ui#articles)
and longer [tutorials](https://rformassspectrometry.github.io/docs/)),
tested and flexible [R
software](https://www.rformassspectrometry.org/pkgs/) for the analysis
...
- The [Spectra](https://rformassspectrometry.github.io/Spectra/)
...
- The
  [MsCoreUtils](https://rformassspectrometry.github.io/MsCoreUtils/)
...
- The [PSMatch](https://rformassspectrometry.github.io/PSMatch/)
  package package to load, process and analyse PSMs (Peptide-Spectrum
  Matches).

- The
  [MsExperiment](https://rformassspectrometry.github.io/MsExperiment/)
...
Bioconductor, and can be installed with `BiocManager::install()`. The
code below illustrates this for the `Spectra` package:
